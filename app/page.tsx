  ...
  const features = [
    {
      ...
      description: "Effortlessly manage student records, attendance, and academic progress",
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Your complete solution for managing tuition centers, students, and online examinations
          </p>
        ...
        <div className="text-center bg-blue-600 text-white rounded-lg p-8">
          ...
          <p className="text-lg mb-6">Join thousands of students and teachers already using our platform</p>
