...
import {
  ...
  DollarSign, LogOut, PieChart, Menu, X
} from "lucide-react";
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, role }) => {
  ...
  const adminMenuItems = [
    ...
    { icon: <Calendar size={20} />, label: 'Attendance', href: '/admin/attendance' },
  ...
  const studentMenuItems = [
    ...
    { icon: <GraduationCap size={20} />, label: 'Exams', href: '/student/exams' },
